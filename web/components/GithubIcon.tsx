// Vendored GitHub mark. lucide-react v1 removed brand/logo icons (including
// `Github`), so we ship the official octocat path locally. Filled style matches
// the sibling XIcon/RaintreeLogo brand marks in the footer.
