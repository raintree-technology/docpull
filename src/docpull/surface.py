...
PUBLIC_CLI_COMMANDS: tuple[CliCommand, ...] = (
    ...
    CliCommand("dataset-pack", "Build a v3 pack from local or HTTPS JSON/CSV datasets"),
    ...
    CliCommand("website-pack", "Build a portable baseline-aware website snapshot"),
    ...
    CliCommand("relationship-pack", "Extract cited relationship candidates for human review"),
